...
class org::sbolstandard::core2::Sbol2Terms_Annotation final
...
private:
    static ::javax::xml::namespace_::QName* Annotation__;
    static ::javax::xml::namespace_::QName* relation_;
    static ::javax::xml::namespace_::QName* value_;

    // Generated

public:
    Sbol2Terms_Annotation();
protected:
    Sbol2Terms_Annotation(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& Annotation_();
    static ::javax::xml::namespace_::QName*& relation();
    static ::javax::xml::namespace_::QName*& value();
