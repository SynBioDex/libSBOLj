...
class org::sbolstandard::core2::Sbol2Terms_Collection final
...
private:
    static ::javax::xml::namespace_::QName* Collection__;
    static ::javax::xml::namespace_::QName* hasMembers_;

    // Generated

public:
    Sbol2Terms_Collection();
protected:
    Sbol2Terms_Collection(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& Collection_();
    static ::javax::xml::namespace_::QName*& hasMembers();
