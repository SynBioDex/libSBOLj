...
class org::sbolstandard::core2::Sbol2Terms_Component final
...
private:
    static ::javax::xml::namespace_::QName* Component__;

    // Generated

public:
    Sbol2Terms_Component();
protected:
    Sbol2Terms_Component(const ::default_init_tag&);
