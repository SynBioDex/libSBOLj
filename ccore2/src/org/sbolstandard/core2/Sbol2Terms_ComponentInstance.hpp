...
class org::sbolstandard::core2::Sbol2Terms_ComponentInstance final
...
private:
    static ::javax::xml::namespace_::QName* ComponentInstance__;
    static ::javax::xml::namespace_::QName* access_;
    static ::javax::xml::namespace_::QName* hasMapsTo_;
    static ::javax::xml::namespace_::QName* hasComponentDefinition_;

    // Generated

public:
    Sbol2Terms_ComponentInstance();
protected:
    Sbol2Terms_ComponentInstance(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& ComponentInstance_();
    static ::javax::xml::namespace_::QName*& access();
    static ::javax::xml::namespace_::QName*& hasMapsTo();
    static ::javax::xml::namespace_::QName*& hasComponentDefinition();
