...
class org::sbolstandard::core2::Sbol2Terms_Cut final
...
private:
    static ::javax::xml::namespace_::QName* Cut__;
    static ::javax::xml::namespace_::QName* at_;
...
public:
    Sbol2Terms_Cut();
protected:
    Sbol2Terms_Cut(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& Cut_();
    static ::javax::xml::namespace_::QName*& at();
