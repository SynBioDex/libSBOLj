...
class org::sbolstandard::core2::Sbol2Terms_FunctionalComponent final
...
private:
    static ::javax::xml::namespace_::QName* FunctionalComponent__;
    static ::javax::xml::namespace_::QName* direction_;

    // Generated

public:
    Sbol2Terms_FunctionalComponent();
protected:
    Sbol2Terms_FunctionalComponent(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& FunctionalComponent_();
    static ::javax::xml::namespace_::QName*& direction();
