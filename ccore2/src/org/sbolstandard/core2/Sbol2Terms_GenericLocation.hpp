...
class org::sbolstandard::core2::Sbol2Terms_GenericLocation final
...
private:
    static ::javax::xml::namespace_::QName* GenericLocation__;
    static ::javax::xml::namespace_::QName* orientation_;

    // Generated

public:
    Sbol2Terms_GenericLocation();
protected:
    Sbol2Terms_GenericLocation(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& GenericLocation_();
