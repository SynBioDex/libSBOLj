...
class org::sbolstandard::core2::Sbol2Terms_GenericTopLevel final
...
private:
    static ::javax::xml::namespace_::QName* GenericTopLevel__;
    static ::javax::xml::namespace_::QName* rdfType_;

    // Generated

public:
    Sbol2Terms_GenericTopLevel();
protected:
    Sbol2Terms_GenericTopLevel(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& GenericTopLevel_();
    static ::javax::xml::namespace_::QName*& rdfType();
