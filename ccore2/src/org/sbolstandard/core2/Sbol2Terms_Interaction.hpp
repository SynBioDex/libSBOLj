...
class org::sbolstandard::core2::Sbol2Terms_Interaction final
...
private:
    static ::javax::xml::namespace_::QName* Interaction__;
    static ::javax::xml::namespace_::QName* type_;
    static ::javax::xml::namespace_::QName* hasParticipations_;

    // Generated

public:
    Sbol2Terms_Interaction();
protected:
    Sbol2Terms_Interaction(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& Interaction_();
    static ::javax::xml::namespace_::QName*& type();
    static ::javax::xml::namespace_::QName*& hasParticipations();
