...
class org::sbolstandard::core2::Sbol2Terms_Location final
...
private:
    static ::javax::xml::namespace_::QName* Location__;
...
public:
    Sbol2Terms_Location();
protected:
    Sbol2Terms_Location(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& Location_();
