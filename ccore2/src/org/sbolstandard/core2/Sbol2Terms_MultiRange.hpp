...
class org::sbolstandard::core2::Sbol2Terms_MultiRange final
...
private:
    static ::javax::xml::namespace_::QName* MultiRange__;
    static ::javax::xml::namespace_::QName* hasRanges_;

    // Generated

public:
    Sbol2Terms_MultiRange();
protected:
    Sbol2Terms_MultiRange(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& MultiRange_();
    static ::javax::xml::namespace_::QName*& hasRanges();
