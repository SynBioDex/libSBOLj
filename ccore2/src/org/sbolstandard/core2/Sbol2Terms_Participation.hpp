...
class org::sbolstandard::core2::Sbol2Terms_Participation final
...
private:
    static ::javax::xml::namespace_::QName* Participation__;
    static ::javax::xml::namespace_::QName* role_;
    static ::javax::xml::namespace_::QName* hasParticipant_;

    // Generated

public:
    Sbol2Terms_Participation();
protected:
    Sbol2Terms_Participation(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& Participation_();
    static ::javax::xml::namespace_::QName*& role();
    static ::javax::xml::namespace_::QName*& hasParticipant();
