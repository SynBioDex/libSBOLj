...
class org::sbolstandard::core2::Sbol2Terms_Sequence final
...
private:
    static ::javax::xml::namespace_::QName* Sequence__;
    static ::javax::xml::namespace_::QName* elements_;
    static ::javax::xml::namespace_::QName* encoding_;
...
public:
    Sbol2Terms_Sequence();
protected:
    Sbol2Terms_Sequence(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& Sequence_();
    static ::javax::xml::namespace_::QName*& elements();
    static ::javax::xml::namespace_::QName*& encoding();
