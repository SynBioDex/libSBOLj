...
class org::sbolstandard::core2::Sbol2Terms_SequenceAnnotation final
...
private:
    static ::javax::xml::namespace_::QName* SequenceAnnotation__;
    static ::javax::xml::namespace_::QName* hasComponent_;
    static ::javax::xml::namespace_::QName* hasLocation_;

    // Generated

public:
    Sbol2Terms_SequenceAnnotation();
protected:
    Sbol2Terms_SequenceAnnotation(const ::default_init_tag&);
...
public: /* package */
    ...
    static ::javax::xml::namespace_::QName*& hasLocation();
