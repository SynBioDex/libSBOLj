...
class org::sbolstandard::core2::Sbol2Terms_SequenceConstraint final
...
private:
    static ::javax::xml::namespace_::QName* SequenceConstraint__;
    static ::javax::xml::namespace_::QName* restriction_;
    static ::javax::xml::namespace_::QName* hasSubject_;
    static ::javax::xml::namespace_::QName* hasObject_;

    // Generated

public:
    Sbol2Terms_SequenceConstraint();
protected:
    Sbol2Terms_SequenceConstraint(const ::default_init_tag&);
...
public: /* package */
    static ::javax::xml::namespace_::QName*& SequenceConstraint_();
    static ::javax::xml::namespace_::QName*& restriction();
    static ::javax::xml::namespace_::QName*& hasSubject();
    static ::javax::xml::namespace_::QName*& hasObject();
