...
public class ComponentDefinition extends TopLevel {
	...
	/**
	 * Adds the specified element to the set <code>type</code> if it is not
	 * already present.
	 * 
	 * @param typeURI
	...
	/**
	 * Removes the specified element from the set <code>type</code> if it is
	 * present.
	 * 
	 * @param typeURI
	...
	/**
	 * Removes all entries of the list of <code>type</code> instances owned by
	...
	/**
	 * Calls the SequenceAnnotation constructor to create a new instance using
	 * the specified parameters, then adds to the list of SequenceAnnotation
	 * instances owned by this instance.
	 * 
	 * @param identity
	 * @param location
	 * @return the created SequenceAnnotation instance.
	 */
	public SequenceAnnotation createSequenceAnnotation(URI identity,
			Location location) {
		SequenceAnnotation sequenceAnnotation = new SequenceAnnotation(
				identity, location);
	...
	public void addSequenceAnnotation(SequenceAnnotation sequenceAnnotation) {
		...
		sequenceAnnotations.put(sequenceAnnotation.getIdentity(),
				sequenceAnnotation);
	}
	...
	/**
	 * Test if the optional field variable <code>structuralInstantiations</code>
	 * is set.
	 * 
	...
	/**
	 * Calls the StructuralInstantiation constructor to create a new instance
	 * using the specified parameters, then adds to the list of
	 * StructuralInstantiation instances owned by this instance.
	 * 
	 * @param identity
	 * @param access
	 ...
	 */
	public Component createSubComponent(URI identity, URI access,
			URI subComponentURI) {
		Component subComponent = new Component(identity, access,
				subComponentURI);
	...
	/**
	 * Removes the instance matching the specified URI from the list of
	 * structuralInstantiations if present.
	 * 
	 * @param subComponentURI
	 * @return the matching instance if present, or <code>null</code> if not
	 *         present.
	...
	/**
	 * Removes all entries of the list of structuralInstantiation instances
	...
	/**
	 * Clears the existing list of structuralInstantiation instances, then
	...
	/**
	 * Test if the optional field variable <code>sequenceConstraints</code> is
	 * set.
	 * 
	 * @return <code>true</code> if the field variable is not an empty list
	 */
	...
	/**
	 * Calls the StructuralConstraint constructor to create a new instance using
	 * the specified parameters, then adds to the list of StructuralConstraint
	 * instances owned by this instance.
	 * 
	 * @param identity
	 * @param restriction
	 ...
	 */
	public SequenceConstraint createSequenceConstraint(URI identity,
			URI restriction, URI subject, URI object) {
		SequenceConstraint sequenceConstraint = new SequenceConstraint(
				identity, restriction, subject, object);
	...
	public void addSequenceConstraint(SequenceConstraint sequenceConstraint) {
		...
		sequenceConstraints.put(sequenceConstraint.getIdentity(),
				sequenceConstraint);
	}
	...
	/**
	 * Returns the instance matching the specified URI from the list of sequence
	...
	/**
	 * Returns the list of {@link SequenceConstraint} instances owned by this
	 * instance.
	 * 
	 * @return the list of {@link SequenceConstraint} instances owned by this
	 *         instance.
	 */
	...
	/**
	 * Clears the existing list of structuralConstraint instances, then appends
	 * all of the elements in the specified collection to the end of this list.
	 * 
