...
public class Interaction extends Documented {
	 ...
	 * 
	 * @param identity
	 *            an identity for the interaction
	 * @param type
	 *            a type for the interaction
	 * @param participations
	 *            a collection of participations for the interaction
	 */
	...
	/**
	 * Calls the Participation constructor to create a new instance using the
	 * specified parameters, then adds to the list of Participation instances
	 ...
	 */
	public Participation createParticipation(URI identity, Set<URI> role,
			URI participant) {
		Participation participation = new Participation(identity, role,
				participant);
	...
	/**
	 * Removes all entries of the list of participation instances owned by this
	...
	/**
	 * Clears the existing list of participation instances, then appends all of
