...
public class SBOLDeepEquality {
	...
	// * equal</i> to one another. Unlike the {@link
	// SBOLVisitable#equals(Object)}
	// * method which checks identity equality, this method is appropriate for
	// use with nested arrays of
	// * arbitrary depth.
	// *
	// * <p>Two SBOLVisitable references are considered deeply equal if both
	// * are <tt>null</tt>, or if they refer to objects of same type and their
	// attributes are deeply equal. Two
	// * regular object references (objects that do no implement SBOLVisitable
	// interface) are deeply equal if they are
	// * equal with respect to the standard {@link Object#equals(Object) equal}
	// function.
	// */
	...
	// }
	//
	// public static class EqualityTester extends
	// SBOLBaseVisitor<NotEqualException> {
	// private SBOLVisitable currentObj;
	//
	// public void assertEqual(SBOLVisitable obj1, SBOLVisitable obj2) throws
	// NotEqualException {
	...
	//
	// @Override
	// public void visit(StructuralAnnotation annotation) throws
	// NotEqualException {
	// assertEqual(castCurrentAs(StructuralAnnotation.class), annotation);
	// }
	//
	...
	// }
	//
	// private boolean isBothNullOrSame(Object obj1, Object obj2) throws
	// NotEqualException {
	// if (obj1 == obj2) {
	// return true;
	// }
	...
	// }
	//
	// private void assertEquals(Object obj1, Object obj2) throws
	// NotEqualException {
	...
	// }
	//
	// public void assertEqual(SBOLDocument doc1, SBOLDocument doc2) throws
	// NotEqualException {
	...
	//
	// java.util.Collection<DnaComponent> components1 =
	// collection1.getComponents();
	// java.util.Collection<DnaComponent> components2 =
	// collection2.getComponents();
	// assertEquals(components1.size(), components2.size());
	...
	//
	// java.util.Collection<StructuralAnnotation> annotations1 =
	// component1.getAnnotations();
	// java.util.Collection<StructuralAnnotation> annotations2 =
	// component2.getAnnotations();
	// assertEquals(annotations1.size(), annotations2.size());
	// Iterator<StructuralAnnotation> iter1 = annotations1.iterator();
	// Iterator<StructuralAnnotation> iter2 = annotations2.iterator();
	// while (iter1.hasNext()) {
	// assertEqual(iter1.next(), iter2.next());
	// }
	// }
	...
	// }
	//
	// public void assertEqual(StructuralAnnotation annotation1,
	// StructuralAnnotation annotation2) throws NotEqualException {
	...
	//
	// assertEqual(annotation1.getSubComponent(),
	// annotation2.getSubComponent());
	//
	// java.util.Collection<StructuralAnnotation> precedes1 =
	// annotation1.getPrecedes();
	// java.util.Collection<StructuralAnnotation> precedes2 =
	// annotation2.getPrecedes();
	// assertEquals(precedes1.size(), precedes2.size());
	// Iterator<StructuralAnnotation> iter1 = precedes1.iterator();
	// Iterator<StructuralAnnotation> iter2 = precedes2.iterator();
	// while (iter1.hasNext()) {
	// StructuralAnnotation sa1 = iter1.next();
	// StructuralAnnotation sa2 = iter2.next();
