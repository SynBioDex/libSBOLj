...
public class SBOLDocument {
	...
	public SBOLDocument() {
		...
		nameSpaces.put(URI.create(Sbol2Terms.sbol2.getNamespaceURI()),
				Sbol2Terms.sbol2);
	}
	...
	/**
	 * Appends the specified <code>module</code> to the end of the list of
	 * modules.
	 * 
	 * @param moduleDefinition
	 */
	public void addModuleDefinition(ModuleDefinition moduleDefinition) {
		// TODO: Recursively check the uniqueness of URIs of each Module and its
		// field variables.
		moduleDefinitions.put(moduleDefinition.getIdentity(), moduleDefinition);
	}

	/**
	 * Removes the instance matching the specified URI from the list of modules
	 * if present.
	 * 
	 ...
	 * structuralConstraints if present.
	 * 
	 * @param moduleURI
	 * @return the matching instance if present, or <code>null</code> if not
	 *         present.
	...
	/**
	 * Removes all entries of the list of structuralConstraint instances owned
	...
	/**
	 * Appends the specified <code>collection</code> to the end of the list of
	 * collections.
	 * 
	 * @param collection
	 */
	public void addCollection(Collection collection) {
		// TODO: Recursively check the uniqueness of URIs of each Collection and
		// its field variables.
	...
	/**
	 * Returns the list of <code>Collection</code> instances owned by this
	 * instance.
	 * 
	 * @return the list of <code>Collection</code> instances owned by this
	 *         instance
	 */
	...
	/**
	 * Clears the existing list <code>collections</code>, then appends all of
	 ...
	 * @return
	 */
	public Model createModel(URI identity, URI source, URI language,
			URI framework, Set<URI> roles) {
	...
	/**
	 * Appends the specified <code>model</code> to the end of the list of
	 * models.
	 * 
	 * @param model
	 */
	public void addModel(Model model) {
		// TODO: Recursively check the uniqueness of URIs of each Model and its
		// field variables.
	 ...
	 * @return
	 */
	public ComponentDefinition createComponentDefinition(URI identity,
			Set<URI> type, Set<URI> roles) {
		ComponentDefinition newComponentDefinition = new ComponentDefinition(
				identity, type, roles);
	...
	/**
	 * Appends the specified element to the end of the list of component
	 * definitions.
	 * 
	 * @param componentDefinition
	 */
	public void addComponentDefinition(ComponentDefinition componentDefinition) {
		// TODO: Recursively check the uniqueness of URIs of each Component and
		// its field variables.
		componentDefinitions.put(componentDefinition.getIdentity(),
				componentDefinition);
	}

	/**
	 * Removes the instance matching the specified URI from the list of
	 * component definitions if present.
	 * 
	 * @param structuralConstraintURI
	 * @return the matching instance if present, or <code>null</code> if not
	 *         present.
	 */
	public ComponentDefinition removeComponentDefinition(
	...
	/**
	 * Returns the list of <code>ComponentDefinition</code> instances owned by
	 * this instance.
	 * 
	 * @return the list of <code>ComponentDefinition</code> instances owned by
	 *         this instance
	 */
	...
	/**
	 * Clears the existing list of component definitions, then appends all of
	 * the elements in the specified collection to the end of this list.
	 * 
	...
	/**
	 * Appends the specified <code>structure</code> to the end of the list of
	 * structures.
	 * 
	 * @param sequence
	 */
	public void addSequence(Sequence sequence) {
		// TODO: Recursively check the uniqueness of URIs of each Structure and
		// its field variables.
	...
	/**
	 * Returns the list of <code>Structure</code> instances owned by this
	 * instance.
	 * 
	 * @return the list of <code>Structure</code> instances owned by this
	 *         instance
	 */
	...
	/**
	 * Clears the existing list <code>structures</code>, then appends all of the
	 * elements in the specified collection to the end of this list.
	 * 
	 * @param sequences
	 */
	...
	public GenericTopLevel createGenericTopLevel(URI identity, QName rdfType) {
		GenericTopLevel newGenericTopLevel = new GenericTopLevel(identity,
				rdfType);
	...
	/**
	 * Appends the specified <code>topLevel</code> to the end of the list of
	 * topLevels.
	 * 
	 * @param topLevel
	 */
	public void addGenericTopLevel(GenericTopLevel topLevel) {
		// TODO: Recursively check the uniqueness of URIs of each
		// GenericTopLevel and its field variables.
		topLevels.put(topLevel.getIdentity(), topLevel);
	}

	/**
	 * Removes the instance matching the specified URI from the list of
	 * topLevels if present.
	 * 
	 * @param structuralConstraintURI
	 * @return the matching instance if present, or <code>null</code> if not
	 *         present.
	...
	/**
	 * Returns the list of <code>GenericTopLevel</code> instances owned by this
	 * instance.
	 * 
	 * @return the list of <code>GenericTopLevel</code> instances owned by this
	 *         instance
	 */
	...
	/**
	 * Clears the existing list <code>topLevels</code>, then appends all of the
	 * elements in the specified collection to the end of this list.
	 * 
	 * @param topLevels
	 */
