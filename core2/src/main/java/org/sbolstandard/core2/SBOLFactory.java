...
/**
 * SBOL factory class that provides functionality to create SBOL objects and
 * utility classes such as readers, writers, and validators.
 * 
 * @author Evren Sirin
 */
public class SBOLFactory {
	...
	//
	// /**
	// * Creates a fresh SBOL document instance and populates its contents from
	// the given XML source. The reader will
	// * perform validation automatically. The documents read by this reader are
	// guaranteed to be valid so it is not
	// * necessary to perform {@link #validate(SBOLDocument) validation}. If the
	// contents of the document is changed
	// * afterwards, validation will be needed.
	// *
	// * @throws SBOLValidationException if the contents of the document is not
	// valid
	// */
	// public static SBOLDocument read(InputStream in) throws IOException,
	// SBOLValidationException {
	// return READER.read(in);
	// }
	//
	// /**
	// * Writes the contents of an SBOL document in XML format to the given
	// output stream. The writer will
	// * perform validation automatically.
	// *
	// * @throws SBOLValidationException if the contents of the document is not
	// valid
	// */
	// public static void write(SBOLDocument doc, OutputStream out) throws
	...
	// valid
	// */
	// public static void validate(SBOLDocument doc) throws
	// SBOLValidationException {
	// VALIDATOR.validate(doc);
	// }
	//
	// /**
	// * Creates a new reader instance for reading from XML documents that will
	// automatically perform validation and
	...
	//
	// /**
	// * Creates a new reader instance for writing SBOL documents as XML that
	// will NOT perform validation. The documents
	// * read by this reader may not be written successfully if the writer
	// performs validation.
	// *
	// */
	...
	//
	// /**
	// * Creates a new writer instance for writing SBOL documents as XML that
	// will automatically perform validation and
	// * will refuse to write invalid documents. WARNING: If validation fails
	// while writing the contents of the document,
	// * the output may still contain partial serialization results that has
	// been written before the error is discovered.
	// */
	...
	// * Creates a new writer instance for writing SBOL documents as XML that
	// will NOT perform validation. THe documents
	// * written by this writer may not be read successfully if the reader
	// performs validation.
	// */
	...
	//
	// /**
	// * Creates a new empty {@link StructuralAnnotation} instance.
	// */
	// public static StructuralAnnotation createSequenceAnnotation() {
