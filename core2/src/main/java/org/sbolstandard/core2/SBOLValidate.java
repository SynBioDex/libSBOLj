...
//	}
	...
	private static void usage() {
		...
		System.err.println("\t-l  <language> specfies language (SBOL1/SBOL2/GenBank/FASTA/SnapGene/GFF3) for output (default=SBOL2)");
	...
	public static void main(String[] args) {
		...
		if (!isDirectory) {
			validate(System.out,System.err,fileName, URIPrefix, "", complete, compliant, bestPractice, typesInURI, 
					...
					topLevelURIStr, genBankOut, sbolV1out, fastaOut, snapGeneOut, gff3Out, outputFile, 
					showDetail, noOutput, changeURIprefix);
		} else {
