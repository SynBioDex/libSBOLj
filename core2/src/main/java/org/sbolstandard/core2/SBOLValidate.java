...
public class SBOLValidate {
	 ...
	 * 
	 * @param outputStream
	 *            - stream for the output messages
	 * @param errorStream
	 *            - stream for the error messages
	 * @param fileName
	 *            - Input SBOL file name
	 * @param URIPrefix
	 *            - Default URI prefix to set the SBOL Document to be read in or to
	 *            be created.
	 * @param complete
	 *            - Set boolean variable to false to allow SBOL document to be
	 *            incomplete. True otherwise.
	 * @param compliant
	 *            - Set boolean variable to false to allow non-compliant URIs. True
	 *            otherwise.
	 * @param bestPractice
	 *            - Set boolean variable to true to check best practices. False
	 *            otherwise.
	 * @param typesInURI
	 *            - Set boolean variable to true to indicate that types are inserted
	 *            into top-level identity URIs when they are created of the SBOL
	 *            Document.
	 * @param version
	 *            - Specify the version to use for converted SBOL objects.
	 * @param keepGoing
	 *            - Set boolean variable to false to indicate fail on first error
	 *            and stop program from continuing. True otherwise.
	 * @param compareFile
	 *            - Second SBOL file to compare to the primary SBOL file.
	 * @param compareFileName
	 *            - The name of the second SBOL file to compare to the primary SBOL
	 *            file.
	 * @param mainFileName
	 *            - Primary SBOL file to compare to the second SBOL file.
	 * @param topLevelURIStr
	 *            - Specify the top level URI SBOL object contained within the given
	 *            SBOL Document.
	 * @param genBankOut
	 *            - Set boolean variable to true to convert input file to GenBank.
	 *            False otherwise.
	 * @param sbolV1out
	 *            - Set boolean variable to true to convert input file to SBOL1.
	 *            False otherwise.
	 * @param fastaOut
	 *            - Set boolean variable to true to convert input file to FASTA.
	 *            False otherwise.
	 * @param outputFile
	 *            - The specified output name to be generated if the validation must
	 *            produce an output file.
	 * @param showDetail
	 *            - Set boolean variable to true to display detailed error trace.
	 *            False otherwise.
	 * @param noOutput
	 *            - Set boolean variable to true to indicate no output file to be
	...
	public static void main(String[] args) {
		...
		if (!isDirectory) {
			validate(System.out, System.err, fileName, URIPrefix, complete, compliant, bestPractice, typesInURI,
					version, keepGoing, compareFile, compareFileName, mainFileName, topLevelURIStr, genBankOut,
					sbolV1out, fastaOut, outputFile, showDetail, noOutput, true);
		} else {
			for (File eachFile : file.listFiles()) {
				...
				validate(System.out, System.err, eachFile.getAbsolutePath(), URIPrefix, complete, compliant,
						bestPractice, typesInURI, version, keepGoing, compareFile, compareFileName, mainFileName,
						topLevelURIStr, genBankOut, sbolV1out, fastaOut, outputFile, showDetail, noOutput, true);
			}
		}
	}
