...
//	private static OpenSmilesParser openSmilesParser = new OpenSmilesParser();
	...
	/**
	 * Compares the given two SBOL documents and outputs the difference into the list of errors.
	 *   
	 ...
	 */
	public static SBOLDocument validate(PrintStream outputStream, PrintStream errorStream, 
			String fileName, String URIPrefix, boolean complete, 
			...
			boolean noOutput, boolean changeURIPrefix) {
		try {
