...
//		  public static final QName ComponentInstantiation 		= sbol2.withLocalPart("ComponentInstantiation");
		  ...
		  public static final QName references 					= sbol2.withLocalPart("references"); 
	  }
...
//		  public static final QName participation 	  = sbol2.withLocalPart("Participation");
	  ...
	  public static final class Module {
		  ...
		  public static final QName roles						= sbol2.withLocalPart("roles");
		  public static final QName hasModuleInstantiations		= sbol2.withLocalPart("moduleInstantiations");
		  public static final QName hasInteractions 			= sbol2.withLocalPart("interactions");
		  public static final QName hasModels 					= sbol2.withLocalPart("models");
		  public static final QName hasfunctionalInstantiations = sbol2.withLocalPart("functionalInstantiations");
