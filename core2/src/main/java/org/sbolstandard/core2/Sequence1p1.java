 ...
 * @version 2.0
 */
public class Sequence1p1 extends Identified {
	...
	// * sequence text.
	// * c.The sequence text must be in ASCII or UTF-8 encoding. For the
	// alphabets
	...
	public Sequence1p1(URI identity, URI persistentIdentity, String version) {
		super(identity);
