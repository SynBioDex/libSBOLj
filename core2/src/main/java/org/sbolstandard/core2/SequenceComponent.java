...
public class SequenceComponent { //extends Component {
	 ...
	 * @deprecated As of release 2.0, replaced by {@link #setSequence(Sequence1p1)}
	 */
	@Deprecated
     ...
     * @deprecated As of release 2.0, replaced by {@link #addSequenceAnnotation(SequenceAnnotation)}
     */
	@Deprecated
