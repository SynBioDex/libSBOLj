...
public class SequenceComponent { // extends Component {
	...
	private Sequence1p1 sequence;
	private Collection<SequenceAnnotation> sequenceAnnotations;

	/**
	 * 
	 * @param identity
	 *            an identity for the sequence component
	 * @param displayId
	 *            a display ID for the sequence component
	 * @param type
	 *            a type for the sequence component
	 */
	...
	/**
	 * @deprecated Creating an empty Sequence object is not recommended. See
	 *             {@link #SequenceComponent(URI, String, URI)}
	 */
	@Deprecated
	 ...
	 * 
	 * @param sequenceType
	 *            a sequence type for the sequence component
	 */
	 ...
	 */
	public Sequence1p1 getSequence() {
		return sequence;
	}
	 ...
	 * 
	 * @return 1 {@link DnaSequence} specifying the DNA sequence of this
	 *         DnaComponent
	 * @see DnaSequence
	 * @deprecated As of release 2.0, replaced by {@link #getSequence()}
	 */
	@Deprecated
	public Sequence1p1 getDnaSequence() {
		return sequence;
	}
	 ...
	 * 
	 * @param sequence
	 *            a sequence for the sequence component
	 */
	public void setSequence(Sequence1p1 sequence) {
	 ...
	 * 
	 * @param dnaSequence
	 *            specify the DnaSequence of this DnaComponent
	 * @deprecated As of release 2.0, replaced by
	 *             {@link #setSequence(Sequence1p1)}
	 */
	@Deprecated
	public void setDnaSequence(Sequence1p1 value) {
		this.sequence = value;
	}
	 ...
	 * @see #addAnnotation
	 * @deprecated As of release 2.0, replaced by
	 *             {@link #getSequenceAnnotations()}
	 */
	@Deprecated
	public ArrayList<SequenceAnnotation> getAnnotations() {
		return (ArrayList<SequenceAnnotation>) this.sequenceAnnotations;
	}

	/**
	 * 
	 * @param sequenceAnnotation
	 *            a sequence annotation for the sequence component
	 */
	 ...
	 * describes the DNA sequence. The DnaComponent could be left un-annotated,
	 * but that condition is not a very useful to users.
	 * 
	 * @param annotation
	 *            a <code>SequenceAnnotation</code> that describes the DNA
	 *            composition
	 * @deprecated As of release 2.0, replaced by
	 *             {@link #addSequenceAnnotation(SequenceAnnotation)}
	 */
	@Deprecated
	 ...
	 * components. TO DO: implement use of SO within libSBOLj.
	 * 
	 * @return a Sequence Ontology (SO) vocabulary term to describe the type of
	 *         DnaComponent.
	 ...
	 *
	 * @param type
	 *            Sequence Ontology URI specifying the type of the DnaComponent
	...
	// //@XmlAttribute(name = "resource", namespace =
	// "http://www.w3.org/1999/02/22-rdf-syntax-ns#", required = true)
	...
	//
	// //@XmlAccessorType(XmlAccessType.NONE)
	// public static class SequenceAnnotationWrapper extends
	// WrappedValue<SequenceAnnotation> {
