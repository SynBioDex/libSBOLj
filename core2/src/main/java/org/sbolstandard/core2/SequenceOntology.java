...
public class SequenceOntology {
	...
	/**
	 * Namespace of the Sequence Ontology (<a
	 * href="http://purl.obolibrary.org/obo/"
	 * >http://purl.obolibrary.org/obo/</a>).
	 */
	public static final URI NAMESPACE = URI
			.create("http://purl.obolibrary.org/obo/");
	...
	/**
	 * Creates a new URI from the Sequence Ontology namespace with the given
	 * local name. For example, the function call
	 * <value>term("SO_0000001")</value> will return the URI
	 * <value>http://purl.obolibrary.org/obo/SO_0000001</value>
	 */
	...
	/**
	 * A regulatory_region composed of the TSS(s) and binding sites for
	 * TF_complexes of the basal transcription machinery (<a
	 * href="http://purl.obolibrary.org/obo/SO_0000167">SO_0000167</a>).
	 */
	public static final URI PROMOTER = type("SO_0000167");

	/**
	 * A regulatory element of an operon to which activators or repressors bind,
	 * thereby effecting translation of genes in that operon (<a
	 * href="http://purl.obolibrary.org/obo/SO_0000057">SO_0000057</a>).
	 */
	public static final URI OPERATOR = type("SO_0000057");

	/**
	 * A contiguous sequence which begins with, and includes, a start codon, and
	 * ends with, and includes, a stop codon (<a
	 * href="http://purl.obolibrary.org/obo/SO_0000316">SO_0000316</a>).
	 */
	public static final URI CDS = type("SO_0000316");

	/**
	 * A region at the 5' end of a mature transcript (preceding the initiation
	 * codon) that is not translated into a protein (<a
	 * href="http://purl.obolibrary.org/obo/SO_0000204">SO_0000204</a>).
	 */
	 ...
	 * causes RNA polymerase to terminate transcription (<a
	 * href="http://purl.obolibrary.org/obo/SO_0000141">SO_0000141</a>).
	 */
	public static final URI TERMINATOR = type("SO_0000141");

	/**
	 * A transcriptional cis regulatory region that, when located between a CM
	 * and a gene's promoter, prevents the CRM from modulating that genes
	 * expression (<a
	 * href="http://purl.obolibrary.org/obo/SO_0000627">SO_0000627</a>)
	 */
	public static final URI INSULATOR = type("SO_0000627");

	/**
	 * The origin of replication; starting site for duplication of a nucleic
	 * acid molecule to give two identical copies (<a
	 * href="http://purl.obolibrary.org/obo/SO_0000296">SO_0000296</a>).
	 */
	 ...
	 * transcription, or reverse transcription (<a
	 * href="http://purl.obolibrary.org/obo/SO_0005850">SO_0005850<a/>)
	 */
	public static final URI PRIMER_BINDING_SITE = type("SO_0005850");

	/**
	 * Represents a region of a DNA molecule which is a nucleotide region
	 * (usually a palindrome) that is recognized by a restriction enzyme (<a
	 * href="http://purl.obolibrary.org/obo/SO_0001687">SO_0001687</a>).
	 */
