...
public class writeTester {
	...
	private static Collection get_myParts(SBOLDocument SBOL2Doc_test) {
		SBOL2Doc_test.addNameSpaceBinding(
				URI.create("http://myannotation.org"), "annot");
		Collection myParts = createCollection(
				SBOL2Doc_test,
				getData("myParts/1/0", "myParts", "1.0", "myParts", "myParts",
						"myParts"),
				getAnnotation_List(createAnnotation(new QName(
						"http://myannotation.org", "thisAnnotation", "annot"),
						createTurtle())));
	...
	private static TopLevel get_topLevel(SBOLDocument SBOL2Doc_test) {
		...
		return createTopLevel(
				SBOL2Doc_test,
				getData("GenericTopLevel/1/0", "GenericTopLevel", "1.0",
	...
	private static Sequence get_pLacSeq(SBOLDocument SBOL2Doc_test) {
		return createSequenceData(
				SBOL2Doc_test,
				getData("pLacSeq/1/0", "pLacSeq", "1.0", "pLacSeq", "pLacSeq",
						"pLacSeq", "pLacSeq_element"),
	...
	private static Sequence get_tetRSeq(SBOLDocument SBOL2Doc_test) {
		return createSequenceData(
				SBOL2Doc_test,
				getData("tetRSeq/1/0", "tetRSeq", "1.0", "tetRSeq", "tetRSeq",
						"tetRSeq", "tetRSeq_element"),
	...
	private static Sequence get_pLactetRSeq(SBOLDocument SBOL2Doc_test) {
		return createSequenceData(
				SBOL2Doc_test,
				getData("pLactetRSeq/1/0", "pLactetRSeq", "1.0", "pLactetRSeq",
						"pLactetRSeq", "pLactetRSeq", "pLactetRSeq_element"),
	...
	private static ComponentDefinition get_pLac(SBOLDocument SBOL2Doc_test) {
		return createComponentDefinitionData(SBOL2Doc_test,
				getSetPropertyURI("DNA"), getSetPropertyURI("Promoter"),
	...
	private static ComponentDefinition get_tetR(SBOLDocument SBOL2Doc_test) {
		return createComponentDefinitionData(SBOL2Doc_test,
				getSetPropertyURI("DNA"), getSetPropertyURI("CDS"),
				getData("tetRCDS/1/0", "tetR", "1.0", "tetR", "tetR", "tetR"),
				get_tetRSeq(SBOL2Doc_test), null, null, null);
	}
	...
	private static SequenceAnnotation get_p_sequenceAnnotate(
			SBOLDocument SBOL2Doc_test) {
		return createSequenceAnnotationData(
				getData("p_structAnnotate", "p_structAnnotate", "1.0",
						"p_structAnnotate", "p_structAnnotate",
						"p_structAnnotate"), get_P(SBOL2Doc_test), 0, 10, null);
	}

	private static SequenceAnnotation get_c_sequenceAnnotate(
			SBOLDocument SBOL2Doc_test) {
		return createSequenceAnnotationData(
				getData("p_structAnnotate", "p_structAnnotate", "1.0",
						"p_structAnnotate", "p_structAnnotate",
						"p_structAnnotate"), get_P(SBOL2Doc_test), 11, 20, null);
	}

	private static SequenceConstraint get_struct_constraint(
			SBOLDocument SBOL2Doc_test) {
		return createSequenceConstraintData(
				getData("pLactetR/struct_constraint/1/0", "struct_constraint",
						"1.0"), get_P(SBOL2Doc_test), get_C(SBOL2Doc_test),
				getPropertyURI("precedes"));
	}

	private static ComponentDefinition get_pLactetR(SBOLDocument SBOL2Doc_test) {
		return createComponentDefinitionData(
				SBOL2Doc_test,
				getSetPropertyURI("DNA"),
				getSetPropertyURI("Gene"),
				getData("pLactetR/1/0", "pLactetR", "1.0", "pLactetR",
						"pLactetR", "pLactetR"),
	...
	private static FunctionalComponent get_LacIIn(SBOLDocument SBOL2Doc_test) {
		return createFunctionalComponentData(
				getData("LacI_Inv/LacIIn/1/0", "LacIIn", "1.0", "LacIIn",
						"LacIIn", "LacIIn", "public", "input"),
				get_LacI(SBOL2Doc_test));
	}

	private static FunctionalComponent get_TetROut(SBOLDocument SBOL2Doc_test) {
		return createFunctionalComponentData(
				getData("LacI_Inv/TetROut/1/0", "TetROut", "1.0", "TetROut",
						"TetROut", "TetROut", "public", "output"),
				get_TetR(SBOL2Doc_test));
	}

	private static FunctionalComponent get_LacIInv(SBOLDocument SBOL2Doc_test) {
		return createFunctionalComponentData(
				getData("LacI_Inv/LacIInv/1/0", "LacIInv", "1.0", "LacInv",
						"LacIInv", "LacIInv", "private", "none"),
				get_pLactetR(SBOL2Doc_test));
	}

	private static Participation get_p1a(SBOLDocument SBOL2Doc_test,
			String identity) {
		return createParticipationData(getURI(identity),
				getSetPropertyURI("repressor"), get_LacIIn(SBOL2Doc_test));
	}

	private static Participation get_p2a(SBOLDocument SBOL2Doc_test,
			String identity) {
		return createParticipationData(getURI(identity),
				getSetPropertyURI("repressed"), get_LacIInv(SBOL2Doc_test));
	}

	private static Participation get_p4a(SBOLDocument SBOL2Doc_test,
			String identity) {
		return createParticipationData(getURI(identity),
				getSetPropertyURI("producer"), get_TetRInv(SBOL2Doc_test));
	}

	private static Participation get_p3a(SBOLDocument SBOL2Doc_test,
			String identity) {
		return createParticipationData(getURI(identity),
				getSetPropertyURI("produced"), get_TetROut(SBOL2Doc_test));
	}

	private static Interaction get_interact1a(SBOLDocument SBOL2Doc_test) {
		return createInteractionData(
				getData("LacI_Inv/interact1/1/0", "interact1", "1.0",
						"interact1", "interact1", "interact1"),
				getParticipation_List(
						get_p1a(SBOL2Doc_test, "LacI_Inv/interact1/p1a/1/0"),
						get_p2a(SBOL2Doc_test, "LacI_Inv/interact1/p2a/1/0")),
				getSetPropertyURI("repression"));
	}

	private static Interaction get_interact2a(SBOLDocument SBOL2Doc_test) {
		return createInteractionData(
				getData("LacI_Inv/interact2/1/0", "interact2", "1.0",
						"interact2", "interact2", "interact2"),
				getParticipation_List(
						get_p4a(SBOL2Doc_test, "LacI_Inv/interact2/p4a/1/0"),
						get_p3a(SBOL2Doc_test, "LacI_Inv/interact2/p3a/1/0")),
				getSetPropertyURI("production"));
	}

	private static ModuleDefinition get_LacI_Inv(SBOLDocument SBOL2Doc_test) {
		return createModuleDefinitionData(
				SBOL2Doc_test,
				getSetOfURI("Inverter"),
				getSetPropertyURI("Inverter"),
				getData("LacI_Inv/1/0", "LacI_Inv", "1.0", "LacI_Inv",
						"LacI_Inv", "LacI_Inv"),
				getFunctionalComponent_List(get_LacIIn(SBOL2Doc_test),
						get_TetROut(SBOL2Doc_test), get_LacIInv(SBOL2Doc_test)),
				getInteraction_List(get_interact1a(SBOL2Doc_test),
	...
	private static Sequence get_ptetSeq(SBOLDocument SBOL2Doc_test) {
		return createSequenceData(
				SBOL2Doc_test,
				getData("ptetSeq/1/0", "ptetSeq", "1.0", "ptetSeq", "ptetSeq",
						"ptetSeq", "ptetSeq_element"),
	...
	private static Sequence get_lacISeq(SBOLDocument SBOL2Doc_test) {
		return createSequenceData(
				SBOL2Doc_test,
				getData("lacISeq/1/0", "lacISeq", "1.0", "lacISeq", "lacISeq",
						"lacISeq", "lacISeq_element"),
	...
	private static Sequence get_ptetlacISeq(SBOLDocument SBOL2Doc_test) {
		return createSequenceData(
				SBOL2Doc_test,
				getData("ptetlacISeq/1/0", "ptetlacISeq", "1.0", "ptetlacISeq",
						"ptetlacISeq", "ptetlacISeq", "ptetlacISeq_element"),
	...
	private static ComponentDefinition get_ptet(SBOLDocument SBOL2Doc_test) {
		return createComponentDefinitionData(SBOL2Doc_test,
				...
				get_ptetSeq(SBOL2Doc_test), null, null, null);
	}
	...
	private static ComponentDefinition get_lacI(SBOLDocument SBOL2Doc_test) {
		return createComponentDefinitionData(SBOL2Doc_test,
				...
				get_lacISeq(SBOL2Doc_test), null, null, null);
	}
	...
	private static SequenceAnnotation get_t_structAnnotate(
			SBOLDocument SBOL2Doc_test) {
		return createSequenceAnnotationData(
				getData("ptetlacI/p2_structAnnotate/1/0", "p2_structAnnotate",
						"1.0", "p2_structAnnotate", "p2_structAnnotate",
						"p2_structAnnotate"),
				get_T(SBOL2Doc_test),
				0,
				10,
	...
	private static SequenceAnnotation get_l_structAnnotate(
			SBOLDocument SBOL2Doc_test) {
		return createSequenceAnnotationData(
				getData("ptetlacI/c2_structAnnotate/1/0", "c2_structAnnotate",
						"1.0", "c2_structAnnotate", "c2_structAnnotate",
						"c2_structAnnotate"),
				get_L(SBOL2Doc_test),
				11,
				20,
	...
	private static ComponentDefinition get_ptetlacI(SBOLDocument SBOL2Doc_test) {
		return createComponentDefinitionData(
				...
				getSetPropertyURI("DNA"),
				getSetPropertyURI("Gene"),
				getData("ptetlacI/1/0", "ptetlacI", "1.0", "ptetlacI",
						"ptetlacI", "ptetlacI"),
				get_ptetlacISeq(SBOL2Doc_test),
				getComponent_List(get_T(SBOL2Doc_test), get_L(SBOL2Doc_test)),
				getSequenceAnnotation_List(get_t_structAnnotate(SBOL2Doc_test),
						get_l_structAnnotate(SBOL2Doc_test)), null);
	}

	private static FunctionalComponent get_TetRIn(SBOLDocument SBOL2Doc_test) {
		return createFunctionalComponentData(
				getData("TetR_Inv/TetRIn/1/0", "TetRIn", "1.0", "TetRIn",
						"TetRIn", "TetRIn", "public", "input"),
				get_TetR(SBOL2Doc_test));
	}

	private static FunctionalComponent get_LacIOut(SBOLDocument SBOL2Doc_test) {
		return createFunctionalComponentData(
				getData("TetR_Inv/LacIOut/1/0", "LacIOut", "1.0", "LacIOut",
						"LacIOut", "LacIOut", "public", "output"),
				get_LacI(SBOL2Doc_test));
	}

	private static FunctionalComponent get_TetRInv(SBOLDocument SBOL2Doc_test) {
		return createFunctionalComponentData(
				getData("TetR_Inv/TetRInv/1/0", "TetRInv", "1.0", "TetRInv",
						"TetRInv", "TetRInv", "private", "none"),
				get_ptetlacI(SBOL2Doc_test));
	}

	private static Participation get_p1b(SBOLDocument SBOL2Doc_test,
			String identity) {
		return createParticipationData(getURI(identity),
				getSetPropertyURI("repressor"), get_TetRIn(SBOL2Doc_test));
	}

	private static Participation get_p2b(SBOLDocument SBOL2Doc_test,
			String identity) {
		return createParticipationData(getURI(identity),
				getSetPropertyURI("repressed"), get_TetRInv(SBOL2Doc_test));
	}

	private static Participation get_p4b(SBOLDocument SBOL2Doc_test,
			String identity) {
		return createParticipationData(getURI(identity),
				getSetPropertyURI("producer"), get_TetRInv(SBOL2Doc_test));
	}

	private static Participation get_p3b(SBOLDocument SBOL2Doc_test,
			String identity) {
		return createParticipationData(getURI(identity),
				getSetPropertyURI("produced"), get_LacIOut(SBOL2Doc_test));
	}

	private static Interaction get_interact1b(SBOLDocument SBOL2Doc_test) {
		return createInteractionData(
				getData("TetR_Inv/interact1b/1/0", "interact1b", "1.0",
						"interact1b", "interact1b", "interact1b"),
				getParticipation_List(
						get_p1b(SBOL2Doc_test, "TetR_Inv/interact1b/p1b/1/0"),
						get_p2b(SBOL2Doc_test, "TetR_Inv/interact1b/p2b/1/0")),
				getSetPropertyURI("repression"));
	}

	private static Interaction get_interact2b(SBOLDocument SBOL2Doc_test) {
		return createInteractionData(
				getData("TetR_Inv/interact2b/1/0", "interact2b", "1.0",
						"interact2b", "interact2b", "interact2b"),
				getParticipation_List(
						get_p4b(SBOL2Doc_test, "TetR_Inv/interact2b/p4b/1/0"),
						get_p3b(SBOL2Doc_test, "TetR_Inv/interact2b/p3b/1/0")),
				getSetPropertyURI("production"));
	}
	...
	private static ModuleDefinition get_TetR_Inv(SBOLDocument SBOL2Doc_test) {
		return createModuleDefinitionData(
				...
				getSetOfURI("Inverter"),
				getSetPropertyURI("Inverter"),
				getData("TetR_Inv/1/0", "TetR_Inv", "1.0", "TetR_Inv",
						"TetR_Inv", "TetR_Inv"),
				getFunctionalComponent_List(get_TetRIn(SBOL2Doc_test),
						get_LacIOut(SBOL2Doc_test), get_TetRInv(SBOL2Doc_test)),
				getInteraction_List(get_interact1b(SBOL2Doc_test),
	...
	private static FunctionalComponent get_LacISp(SBOLDocument SBOL2Doc_test) {
		return createFunctionalComponentData(
				getData("Toggle/LacISp/1/0", "LacISp", "1.0", "LacISp",
						"LacISp", "LacISp", "public", "input"),
				get_LacI(SBOL2Doc_test));
	}

	private static FunctionalComponent get_TetRSp(SBOLDocument SBOL2Doc_test) {
		return createFunctionalComponentData(
				getData("Toggle/TetRSp/1/0", "TetRSp", "1.0", "TetRSp",
						"TetRSp", "TetRSp", "public", "input"),
				get_TetR(SBOL2Doc_test));
	}

	private static Module get_Inv1(SBOLDocument SBOL2Doc_test) {
		return createModuleData(
				getData("Toggle/Inv1/1/0", "Inv1", "1.0", "Inv1", "Inv1",
						"Inv1"),
				get_LacI_Inv(SBOL2Doc_test),
				getMapsTo_List(
						createMapTo(getURI("Toggle/Inv1/Inv1a/1/0"),
								getRefinement("useLocal"),
								get_LacISp(SBOL2Doc_test),
								get_LacIIn(SBOL2Doc_test)),
						createMapTo(getURI("Toggle/Inv1/Inv2a_TetRSp/1/0"),
								getRefinement("useLocal"),
								get_TetRSp(SBOL2Doc_test),
								get_TetROut(SBOL2Doc_test))));
	}

	private static Module get_Inv2(SBOLDocument SBOL2Doc_test) {
		return createModuleData(
				getData("Toggle/Inv2/1/0", "Inv2", "1.0", "Inv2", "Inv2",
						"Inv2"),
				get_TetR_Inv(SBOL2Doc_test),
				getMapsTo_List(
						createMapTo(getURI("Toggle/Inv2/Inv1b/1/0"),
								getRefinement("useLocal"),
								get_LacISp(SBOL2Doc_test),
								get_LacIOut(SBOL2Doc_test)),
						createMapTo(getURI("Toggle/Inv2/Inv2b/1/0"),
								getRefinement("useLocal"),
								get_TetRSp(SBOL2Doc_test),
	...
	private static Model get_ToggleModel(SBOLDocument SBOL2Doc_test) {
		return createModelData(
				SBOL2Doc_test,
				getData("Toggle/ToggleModel/1/0", "ToggleModel", "1.0",
						"ToggleModel", "ToggleModel", "ToggleModel"),
				getSetPropertyURI("ToggleModel_role"),
				getPropertyURI("ToggleModel_source"),
				getPropertyURI("ToggleModel_language"),
				getPropertyURI("ToggleModel_framework"));
	}
	...
	private static ModuleDefinition get_Toggle(SBOLDocument SBOL2Doc_test) {
		return createModuleDefinitionData(
				...
				getData("Toggle/1/0", "Toggle", "1.0", "Toggle", "Toggle",
						"Toggle"),
				getFunctionalComponent_List(get_LacISp(SBOL2Doc_test),
						get_TetRSp(SBOL2Doc_test)),
				null,
	...
	private static void setCommonTopLevelData(TopLevel t, URI identity,
			URI persistentIdentity, String version, String displayId,
			String name, String description) {
		setCommonDocumentedData(t, identity, persistentIdentity, version,
				displayId, name, description);
	}

	private static void setCommonDocumentedData(Documented d, URI identity,
			URI persistentIdentity, String version, String displayId,
			String name, String description) {
	...
	private static void setCommonIdentifiedData(Identified i, URI identity,
			URI persistentIdentity, String version) {
	...
	private static GenericTopLevel createTopLevel(SBOLDocument SBOL2Doc_test,
			List<String> topLevelData) {
		...
		GenericTopLevel toplevel = SBOL2Doc_test.createGenericTopLevel(
				identity, new QName("urn:bbn.com:tasbe:grn",
						"RegulatoryReaction", "grn"));
		SBOL2Doc_test.addNameSpaceBinding(URI.create("urn:bbn.com:tasbe:grn"),
				"grn");

		setCommonTopLevelData(toplevel, identity, persistentIdentity, version,
				displayId, name, description);
		return toplevel;
	}

	private static Collection createCollection(SBOLDocument SBOL2Doc_test,
			List<String> collectionData, List<Annotation> annotations) {
		...
		setCommonTopLevelData(collection, identity, persistentIdentity,
				version, displayId, name, description);
		if (annotations != null)
	...
	private static ComponentDefinition createComponentDefinitionData(
			SBOLDocument SBOL2Doc_test, Set<URI> type, Set<URI> roles,
			List<String> componentData, Sequence structureData,
		...
		ComponentDefinition c = SBOL2Doc_test.createComponentDefinition(
				identity, type, roles);
		setCommonTopLevelData(c, identity, persistentIdentity, version,
				displayId, name, description);
		...
		if (structureInstantiationData != null) {
			...
			if (structureAnnotationData != null
					&& structureConstraintData == null)
	...
	private static FunctionalComponent createFunctionalComponentData(
			List<String> functionalInstantiation_data, ComponentDefinition c) {
		...
		FunctionalComponent f = new FunctionalComponent(identity, access,
				instantiatedComponent, direction);
		setCommonDocumentedData(f, identity, persistentIdentity, version,
				displayId, name, description);
	...
	private static Interaction createInteractionData(
			List<String> interaction_data, List<Participation> participations,
			Set<URI> type) {
	...
	private static MapsTo createMapTo(URI identity, RefinementType refinement,
		...
		return new MapsTo(identity, refinement, pre_fi.getIdentity(),
				post_fi.getIdentity());
	}

	private static Model createModelData(SBOLDocument doc,
			List<String> modeldata, Set<URI> roles, URI source, URI language,
			URI framework) {
		...
		Model model = doc.createModel(identity, source, language, framework,
				roles);
		setCommonTopLevelData(model, identity, persistentIdentity, version,
				displayId, name, description);

		return model;
	}

	private static ModuleDefinition createModuleDefinitionData(
			SBOLDocument SBOL2Doc_test, Set<URI> type, Set<URI> roles,
			List<String> module_data,
			List<FunctionalComponent> functionalInstantiation_data,
			List<Interaction> interactionData,
			List<Module> moduleInstantiation_data, Set<URI> model_data,
		...
		ModuleDefinition m = SBOL2Doc_test.createModuleDefinition(identity,
				roles);
		setCommonTopLevelData(m, identity, persistentIdentity, version,
				displayId, name, description);
		if (annotations != null)
	...
	private static Module createModuleData(
			List<String> moduleInstantiation_data, ModuleDefinition m,
			List<MapsTo> maps) {
	...
	private static Participation createParticipationData(URI identity,
			Set<URI> roles, FunctionalComponent fi) {
		return new Participation(identity, roles, fi.getIdentity());
	}

	private static SequenceAnnotation createSequenceAnnotationData(
			List<String> structuralAnnotations_data, Component ref_component,
			int startRange, int endRange, URI locationURI) {
		...
		setCommonDocumentedData(s, identity, persistentIdentity, version,
				displayId, name, description);
	...
	private static SequenceConstraint createSequenceConstraintData(
			...
			Component pre_structInstant, Component post_structInstant,
			URI restriction) {
		...
		SequenceConstraint s = new SequenceConstraint(identity, restriction,
				subject, object);
	...
	private static Component createComponentData(
			List<String> structuralInstantiations_data, ComponentDefinition c) {
	...
	private static Sequence createSequenceData(SBOLDocument SBOL2Doc_test,
			List<String> structureData, URI encoding) {
		...
		Sequence structure = SBOL2Doc_test.createSequence(identity, element,
				encoding);
		setCommonTopLevelData(structure, identity, persistentIdentity, version,
				displayId, name, description);
	...
	/**
	 * data[] = identity data[] = persistentIdentity data[] = version data[] =
	 * displayID data[] = Name data[] = Description
	 * 
	 * @param data
	 * @return
	 */
	...
	private static List<FunctionalComponent> getFunctionalComponent_List(
			FunctionalComponent... fi) {
	...
	private static List<SequenceAnnotation> getSequenceAnnotation_List(
			SequenceAnnotation... sa) {
		return new ArrayList<SequenceAnnotation>(Arrays.asList(sa));
	}

	private static List<SequenceConstraint> getSequenceConstraint_List(
			SequenceConstraint... sc) {
