...
public class writeTester_myDNA {
	...
	public static void write(SBOLDocument doc, OutputStream out)
		...
		// DocumentRoot(
		// NamespaceBindings(NamespaceBinding("http://sbols.org/v2#","sbol2")),
		// TopLevelDocuments(getTopLevelDocument(doc))));
	}

	// private static List<TopLevelDocument<QName>>
	// getTopLevelDocument(SBOLDocument doc) {
	// List<TopLevelDocument<QName>> topLevelDoc = new
	// ArrayList<TopLevelDocument<QName>>();
	...
	/*
	 * SBOLDocument SBOL2Doc_test, Set<URI> type, Set<URI> roles, List<String>
	 * componentData, Structure structureData, List<StructuralInstantiation>
	 * structureInstantiationData, List<StructuralAnnotation>
	 * structureAnnotationData, List<StructuralConstraint>
	 * structureConstraintData)
	 */
	private static ComponentDefinition get_myDNA(SBOLDocument SBOL2Doc_test) {
		return createComponentData(
				...
				getData("MyDnaComponent/1/0", "MyDnaComponent", "1.0",
						"MyDnaComponent", "myDNA",
	...
	private static Sequence get_pLacSeq(SBOLDocument SBOL2Doc_test) {
		return createSequenceData(
				...
				getData("pLacSeq/1/0", "pLacSeq", "1.0", "pLacSeq", "pLacSeq",
						...
						"pLacSeq/pLacSeq_encoding/1/0"));
	}

	private static ComponentDefinition createComponentData(
