...
public class readTester {
	...
	public static String filenameV1_13 	= "SBOL1/precedesTest.xml";

	public static String path = "test/data/";

	public static void main(String[] args) {
		try {
			InputStream file = readTester.class.getResourceAsStream(path +filenameV1_13);
			if (file == null)
				file = readTester.class.getResourceAsStream("/" + path + filenameV1_13);
